...
const Item = require('../lib/models/Item').default;
const Lead = require('../lib/models/Lead').default;
const Opportunity = require('../lib/models/Opportunity').default;
const Quote = require('../lib/models/Quote').default;
const Invoice = require('../lib/models/Invoice').default;
const Payment = require('../lib/models/Payment').default;
const Delivery = require('../lib/models/Delivery').default;
const Payroll = require('../lib/models/Payroll').default;
const Attendance = require('../lib/models/Attendance').default;
const LeaveRequest = require('../lib/models/LeaveRequest').default;
...
async function clearDatabase() {
  ...
  try {
    ...
    // Clear all collections using mongoose models
    ...
    console.log('✅ Cleared opportunities collection');
    
    await Quote.deleteMany({});
    console.log('✅ Cleared quotes collection');
    
    await Invoice.deleteMany({});
    console.log('✅ Cleared invoices collection');
    
    await Payment.deleteMany({});
    console.log('✅ Cleared payments collection');
    
    await Delivery.deleteMany({});
    console.log('✅ Cleared deliveries collection');
    
    await Payroll.deleteMany({});
    console.log('✅ Cleared payrolls collection');
    
    await Attendance.deleteMany({});
    console.log('✅ Cleared attendances collection');
    
    await LeaveRequest.deleteMany({});
    console.log('✅ Cleared leaverequests collection');
...
async function seedDatabase() {
  ...
  try {
    ...
    // 13. Create Attendance Records (sample for January 2024)
